...
FeatureForm, FeatureTemplates
  ...
  const featureLayer = new FeatureLayer({
    url: "https://gis.pdam-sby.go.id/server/rest/services/Data_Spasial/GISPDAM_SURABAYA/FeatureServer/0",
    outFields: ["*"],
    popupEnabled: false,
    id: "incidentsLayer"
  });
